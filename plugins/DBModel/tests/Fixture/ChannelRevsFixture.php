 ...
 *
 */
class ChannelRevsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'state' => ['type' => 'string', 'length' => 12, 'default' => 'Active', 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        'ref_state' => ['type' => 'string', 'length' => 32, 'default' => 'NULL::character varying', 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'state' => 'Lorem ipsu',
            'ref_state' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
